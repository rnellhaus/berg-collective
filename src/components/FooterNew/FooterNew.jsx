      ...
      <div className={`${styles.top} container`}>
        <div className={styles.brand}>
          ...
          <div className={styles.social}>
            ...
            <a href="https://www.tiktok.com/@berg.collective" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={styles.socialLink} style={{ background: '#000', borderColor: '#69C9D0' }}>
